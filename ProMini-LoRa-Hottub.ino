...
#define NODE_ID			 			7			// NodeId of this LoRa Node
...
// #define SEND_TEMPERATURE			3    // 16 sec
// #define SEND_TEMPERATURE_HOT		2    // 16 sec
#define SEND_TEMPERATURE			75  // 10 min
#define SEND_TEMPERATURE_HOT		23  // 3 min
...
volatile unsigned char sendTempTime = SEND_TEMPERATURE;
...
void setup() {
	...
	deviceCount = 3;
#ifdef DEBUG
	Serial.println("Set device count fixed: 3 temperature sensors");
	Serial.println("");
#endif //DEBUG
		...
		for (int i = 0;  i < deviceCount;  i++)
		{
			...
			switch(i) {
				case 0: 
					...
					if (fTemp < 30.0) {
						sendTempTime = SEND_TEMPERATURE;
					} else {
						sendTempTime = SEND_TEMPERATURE_HOT;
					}
					break;
				case 1: 
					txPayload.oneWireTemp2 = 10 * fTemp + 0.5; 
					break;
				case 2: 
					txPayload.oneWireTemp3 = 10 * fTemp + 0.5; 
					break;
			}
#ifdef DEBUG
